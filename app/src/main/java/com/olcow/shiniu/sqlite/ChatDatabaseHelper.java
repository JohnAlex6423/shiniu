...
public class ChatDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table nowmessage(myuid integer,uid integer,name varchar(32),introduction varchar(256),avatar varchar(128),date integer,content varchar(256),count integer)");
    }
